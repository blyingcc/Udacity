...
评估指标的选择-f1和准确度；
算法的选择-基于数据集维度、量级的特点，选择逻辑回归、随机森林进行预训练；
...
本项目通过sparkify音乐APP的海量用户日志文件进行分析，探索数据、构造特征并训练模型进行预测客户是否流失。采用逻辑回归和随机森林算法，经过测试，准确率高达95%，可以考虑在更多的数据进行测试并应用。
项目主要通过pyspark.ml库实现。
这是我的数据挖掘纳米学位的毕业项目，感谢Udacity各位老师、同学的帮助，你们帮我打开一扇门，让我看见数据的辉煌宏美。
博文请见：https://www.cnblogs.com/ceeyo/p/12933371.html