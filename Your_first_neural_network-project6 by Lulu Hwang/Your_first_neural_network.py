...
class NeuralNetwork(object):
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            hidden_error = self.weights_hidden_to_output.T * (hidden_outputs * (1 - hidden_outputs))
...
# 
# #### 多次调整参数选择了这个模型，测试的结果显示12.21日前不错，12.22-31的预测不是很理想，可能因为西方圣诞节的长假导致，模型没有预测到这个节日的影响，对年末假日期间的预测值偏高。原因是数据量太少，训练集只有一个圣诞长假，所以模型很难学习到。
# 
